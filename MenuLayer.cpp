...
void MenuLayer::createMenu()
{
   ...
   // CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("UI_GameMenuText_cn-ipadhd.plist");
	//CCMenuItemSprite* resume = CCMenuItemSprite::create(CCSprite::createWithSpriteFrameName(STATIC_DATA_STRING("button_other_034")),
	//	CCSprite::createWithSpriteFrameName(STATIC_DATA_STRING("bbutton_other_038")), this, menu_selector(MenuLayer::resume));
